...
public class IndexResource {
	...
	public Response index(@HeaderParam("Accept-Language") String lng){
		...
		data.put("resPath", WeinbockServletConfig.resPath);
		data.put("basePath", WeinbockServletConfig.basePath);
		data.put("captchaPubKey", WeinbockServletConfig.captchaPubKey);
